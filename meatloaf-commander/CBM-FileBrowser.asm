...
// !if target = 16 {FkeyStoreArea = $332    // 16 bytes ($332-341)  // 264 series cassette buffer ($332-$3f2)}
// !if target = 128 {FkeyStoreArea = $110    // 20 bytes ($110-123)  // DOS / Print Using work area ($110-$136)}
